...
public class JwtTokenHelper {
    ...
    // Retrieve expiredate from jwt token
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                .setClaims(claims)
                .setSubject(subject)  //userko username set garxa i.e kuna userko token banauna
                .setIssuedAt(now) //tooken issue date
                .setExpiration(expirationDate) //token expire date
                .signWith(getSignedKey(), SignatureAlgorithm.HS256) //token signature or xapa using algorithm
                .compact();
    }
